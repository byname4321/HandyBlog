...
class MyInfo(models.Model):
	...
	email = models.EmailField(max_length=64, default='xxxx@xxxx.xx')
	qq = models.CharField(max_length=64, default='0000000000', verbose_name='QQ')
...
class MyWorks(models.Model):
	...
	homepage = models.CharField(max_length=256, default='http://')
